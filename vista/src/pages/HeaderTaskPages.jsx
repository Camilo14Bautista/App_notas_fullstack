...
function HeaderTaskPages({ openModal, openModalu, useAuth }) {
  ...
  return (
    <nav className=" mt-2 bg-white/60 backdrop-blur-[2px] border-gray-200 dark:bg-gray-900/70 dark:backdrop-blur-[2px]  w-[99%] rounded-lg relative top-0 min-h-16 h-auto flex justify-between items-center shadow-sm z-50">
      <div className="w-full max-w-screen-xl flex flex-wrap items-center justify-between mx-auto pb-4 px-4 pt-2">
        <span className="self-center text-2xl hover:text-purple-600 duration-300 hover:scale-110 hover:duration-300 font-semibold whitespace-nowrap text-gray-700 dark:text-white dark:hover:text-purple-500">
