  ...
  return (
    <div className="w-full h-full flex items-center justify-around flex-col top-0 relative">
      ...
      <div className="w-full h-full flex items-center justify-center">
        <div className="w-full mx-4 h-auto max-w-sm p-4 bg-white/80 border border-gray-200 rounded-2xl shadow sm:p-6 md:p-8 dark:bg-gray-800/70 backdrop-blur-sm dark:border-gray-700 ">
          <h5 className="text-xl font-medium text-gray-900 mb-4 dark:text-white">
            Bienvenido a la App Notas
          </h5>
          ...
          <form className="space-y-6" onSubmit={onSubmit}>
            <div className="mb-5">
              ...
              <input
                ...
                placeholder="nombre o correo cualquiera"
              />
              {errors.email && (
